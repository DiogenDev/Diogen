 ...
 * через next/font, картинки лежат в /public, аналитики нет. Поэтому база это
 ...
 * в динамический рендер, а для лендинга это проигрыш и по скорости, и по стойкости
...
const nextConfig: NextConfig = {
  ...
  // /_next/image это единственная динамическая ручка, которую можно долбить
